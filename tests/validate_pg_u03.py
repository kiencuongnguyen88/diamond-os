...
check('PG_U03_commit_gate_pending',u3.get('human_gate',{}).get('state')=='candidate_build_allowed_commit_gate_pending' and u3.get('repository_binding',{}).get('commit_sha') is None)
