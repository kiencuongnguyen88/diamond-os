...
check("PG_U02_binding_is_exact_commit",u2.get("repository_binding")=={"mode":"exact_commit","base_commit":"df735725a1a724ca3c138a373fdb6dfd3372e4ed","commit_sha":"d1e293703cbb5e504327228dff3aa32a8f71807c"})
check("PG_U02_commit_gate_consumed",u2.get("human_gate",{}).get("state")=="repository_commit_gate_consumed_canon_gate_pending")
...
check("unit_scope_is_PG_U02_only",set(u2["source_hashes"][i]["source_ref_id"] for i in range(4))==set(EXPECTED_HASHES) and u2["state"]=="GIT_CANDIDATE" and u2["canon"] is False)
