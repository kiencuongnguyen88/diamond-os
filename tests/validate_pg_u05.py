...
check('approval_packet_hash',approval['approved_pre_registration_hashes']['repair_packet_sha256']==sha_text('governance/public-units/PG_U05_REPAIRED_EXACT_RECORD_SET_PACKET_v0_1_2.json'))
check('approval_post_system_hash',approval['post_registration_candidate_hashes']['system_protocol_rows_sha256']==sha_text('data/rldb/public-system-protocol-rows.jsonl'))
check('approval_post_class_hash',approval['post_registration_candidate_hashes']['privacy_classification_sha256']==sha_text('data/rldb/record-level-privacy-classification.jsonl'))
check('approval_post_fixture_hash',approval['post_registration_candidate_hashes']['synthetic_fixture_bundles_sha256']==sha_text('data/rldb/synthetic-public-fixtures.jsonl'))
...
check('subset_approval_hash',subset['approval_registration']['sha256']==sha_text('governance/public-units/PG_U05_REPAIRED_EXACT_RECORD_SET_APPROVAL_v0_1_2.json'))
check('subset_approval_proof_hash',subset['approval_registration']['approval_proof_sha256']==APPROVAL_PROOF_SHA)
check('subset_system_hash',subset['record_scope']['system_protocol_rows']['candidate_file_sha256']==sha_text('data/rldb/public-system-protocol-rows.jsonl'))
check('subset_class_hash',subset['privacy_boundary']['record_level_classification_sha256']==sha_text('data/rldb/record-level-privacy-classification.jsonl'))
check('subset_fixture_hash',subset['record_scope']['synthetic_fixture_bundles']['candidate_file_sha256']==sha_text('data/rldb/synthetic-public-fixtures.jsonl'))
...
check('unit_approval_hash',sha_text('governance/public-units/PG_U05_REPAIRED_EXACT_RECORD_SET_APPROVAL_v0_1_2.json') in unit)
